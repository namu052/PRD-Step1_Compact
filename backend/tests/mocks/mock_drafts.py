...
**지방세특례제한법 제36조**에 따르면 서민주택 취득 시 취득세 50%를 경감합니다. [출처: test_law_001]

취득가액 1억원 이하의 주택이 감면 대상입니다. [출처: test_law_001]

영농조합법인이 농업에 직접 사용하기 위하여 취득하는 부동산도 감면 대상입니다. [출처: test_law_002]
