...
async def run_verification_cycle(question: str, ranked_results, evidence_slots: list[EvidenceSlot], draft):
    settings = get_settings()
    max_rounds = 1 if settings.use_mock_llm else max(1, settings.max_verification_rounds)
